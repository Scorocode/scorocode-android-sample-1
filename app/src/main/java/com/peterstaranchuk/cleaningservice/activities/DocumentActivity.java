...
public class DocumentActivity extends AppCompatActivity {
        ...
        document.getDocumentById(getDocumentInfo().getId(), new CallbackGetDocumentById() {
            ...
            public void onDocumentFound(DocumentInfo documentInfo1) {
                ...
                document.updateDocument()
                        ...
                        .set(fieldHelper.photoUrlField(), InputHelper.getStringFrom(etDocumentContent))
                        .set(fieldHelper.descriptionField(), InputHelper.getStringFrom(etDocumentComment));
    ...
    private void loadDocument(DocumentInfo documentInfo) {
        ...
        etDocumentName.setText(fieldHelper.getCleanerNameFrom(documentInfo));
        etDocumentContent.setText(fieldHelper.getCleanerPhotoUrlFrom(documentInfo));
        etDocumentComment.setText(fieldHelper.getCleanerDescriptionFrom(documentInfo));
    }
    ...
    public void onBtnAddDocumentClicked(View addDocumentButton) {
        ...
        document.setField(getString(R.string.cleanerNameField), documentName);
        document.setField(getString(R.string.cleanerPhotoUrl), documentContent);
        document.setField(getString(R.string.cleanerDescription), documentComment);
